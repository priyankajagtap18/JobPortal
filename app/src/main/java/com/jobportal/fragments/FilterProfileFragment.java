...
public class FilterProfileFragment extends Fragment {
    ...
    public static FilterProfileFragment newInstance() {
       /* FragmentHome fragment = new FragmentHome();
        Bundle args = new Bundle();
        fragment.setArguments(args);*/
        return new FilterProfileFragment();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View mRootView = inflater.inflate(R.layout.fragment_filter_profile, container, false);
