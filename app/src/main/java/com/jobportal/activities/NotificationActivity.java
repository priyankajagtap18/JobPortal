...
import com.jobportal.fragments.NotificationFragment;
...
public class NotificationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bindControls();
        setListeners();
        mUtilities.replaceFragment(AppConstants.MAIN_CONTAINER, this, new NotificationFragment(), R.string.hello_fragment, false);
    }
