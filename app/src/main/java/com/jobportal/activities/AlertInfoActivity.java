...
import com.jobportal.fragments.AlertInfoFragment;
...
public class AlertInfoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bindControls();
        setListeners();
        mUtilities.replaceFragment(AppConstants.MAIN_CONTAINER, this, new AlertInfoFragment(), R.string.hello_fragment, false);
    }
